...
uint32_t WcSetupH264Encoder(void) {
  ...
  size_t out_size_calc = (size_t)((float)width * height * ESP_H264_GET_BPP_BY_PIC_TYPE(cfg.pic_type));
  uint32_t out_size = (uint32_t)out_size_calc;
  ...
  Wc.h264.out_buffer_size = (size_t)out_size;
